...
A GAM model using the Fellner-Schall method [mgcv::gam(..., optimizer = "efs")], with a Tweedie error model where the shape and scale parameters vary by bottom depth is used.
